...
import SpecialProduct from "../componnets/SpecialProduct";
...
const Home = () => {
  return (
    <> 
      ...
      <Container class1="fetured-wrapper py-5 home-wrapper-2">
        <div className="row">
          <div className="col-12">
        ...
        <div className="row">
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              />
              <div className="famous-content position-absolute">
                <h5 className="text-dark uppercase">Smart Phones</h5>
                <h6 className="text-dark">Smartphone 13 Pro.</h6>
                <p className="text-dark">
                  Now in Green, from $999.00 or $41.62/mo. for 24 mo. Footnate*
                </p>
              </div>
            </div>
          </div>
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <h6 className="text-dark">Room-fiiling sound.</h6>
                <p className="text-dark">
